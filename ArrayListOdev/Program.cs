                ...
                switch (kullaniciSecim)
                {
                    ...
                    case "3":
                        ...
                        if (kontrol)
                        {
                            ...
                            Console.WriteLine("Değeriniz bulundu : İndex sırası = {0} - Değer = {1}",bulunanIndex,bulunanDeger);
                        }
                    ...
                    case "4":
                        ...
                        {
                            Console.WriteLine("Aradağınız değer liste içinde bulunamadı.");
                        }
                        System.Threading.Thread.Sleep(2000);
                        break;
                    case "5":
                        ...
                        {
                            Console.WriteLine("Kullanıcı içerisinde ki silmek istediğiniz değeri giriniz : ");
